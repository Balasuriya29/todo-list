      ...
      <GestureHandlerRootView
        ...
        <TapGestureHandler
          ...
          <View
            ...
            <AppRow
              ...
              <View>
                <AppText style={{fontFamily: 'Poppins-Bold', fontSize: 32}}>
                  Today
                </AppText>
                <AppText style={{fontFamily: 'Poppins-Light'}}>{now}</AppText>
              </View>
              <AppIcon
        ...
        <AppSliderBottomNavBar
          ...
          <ScrollView
            ...
            ref={scrollForBN}
            scrollEnabled={bottomNavVisible}>
                ...
                {!bottomNavVisible ? (
                  <Pressable
                    ...
                    <AppRow alignItems="center">
                      ...
                      />
                      <AppText
                        style={[styles.pressableText, {color: colors.white}]}>
                        Add New Todo
                      </AppText>
                    </AppRow>
                  </Pressable>
                    ...
                    <React.Fragment>
                      ...
                      <TextInput
                        ...
                        style={[
                          ...
                          {borderColor: colors.grey, color: colors.text},
                        ]}
...
function TodoModelRowComponent({heading, value}) {
  return (
    <View
      ...
      <AppText style={{fontFamily: 'Poppins-Bold', fontSize: 16}}>
        {heading} :{' '}
      </AppText>
...
const styles = StyleSheet.create({
  analysisBar: {fontSize: 15, fontFamily: 'Poppins-SemiBold'},
  addBar: {
    marginHorizontal: 10,
    fontSize: 25,
    alignSelf: 'flex-start',
  ...
  chipModelTitle: {fontFamily: 'Poppins-Bold'},
